...
var apiKey = "9423a33bb51b45d68428b792106fc6d6";

var meetingsData = [];
//var addresses = ["273 Bowery","232 West 11th Street","283 West Broadway"];
var addresses = JSON.parse(fs.readFileSync('../week2/streetAddressesm02.txt'));
...
async.eachSeries(addresses, function(value, callback) {
    ...
    fs.writeFileSync('m02LatLon.json', JSON.stringify(meetingsData));
    console.log('*** *** *** *** ***');
